...
public class AnexoI {
	...
	public AnexoI(Centro coledata, Empresa empdata) {
	...
	public void generarAnexoI(String filename, String filepath) throws FileNotFoundException, DocumentException {
		...
		Paragraph p4 = new Paragraph("\nCONVENIO Nº " + empdata.getNum_Convenio(),
		FontFactory.getFont("arial",   // fuente
				10,                            // tamaño
						Font.BOLD));
				...
				Paragraph p6 = new Paragraph("\nD. " + this.coledata.getNombreCentro() + " " + this.coledata.getDirectorApellidos() +"\ncon NIF " + this.coledata.getNIF() + " como director del Centro Educativo " + this.coledata.getCodigo_Centro() + "\ndomiciliado en " + this.coledata.getCiudad(),
						FontFactory.getFont("arial",   // fuente
						9));
				...
				Paragraph p9 = new Paragraph("\nD. " + this.empdata.getRepresentante() + " " + this.empdata.getApellidos_Representante()+"\ncon NIF " + this.empdata.getNIF_Representante() + " como representante legal de la Empresa/Entidad colaboradora " + this.empdata.getNombre() + "\ndomiciliada en " + this.empdata.getCiudad(),
						FontFactory.getFont("arial",   // fuente
						9));

				documento.add(p9);

				Paragraph p10 = new Paragraph("provincia de " + this.empdata.getProvincia() + " calle," + this.empdata.getDireccion() + "\nC.P. " + this.empdata.getCP() + ", CIF " + this.empdata.getCIF() + ", Telefono " + this.empdata.getTelefono() + ", FaxEmp " + this.empdata.getFax(),
						FontFactory.getFont("arial",   // fuente
						9));
